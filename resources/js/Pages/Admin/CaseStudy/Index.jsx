...
const CaseStudy = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(route("case_study.data"));
            setCaseStudy(response.data.data);
        } catch (error) {
            console.error("Error fetching case_study:", error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const filteredItems = case_study.filter((item) =>
    ...
    const deleteItem = (id) => {
        useDeleteModal(id, "case_study.destroy", () => {
            setCaseStudy((prev) => prev.filter((item) => item.id !== id));
        });
    };

    return (
        <AuthenticatedLayout>
            <Head title=" Case Study" />
                ...
                <div className="w-full mx-auto md:max-w-2xl lg:max-w-7xl">
                    <div className="overflow-auto bg-white shadow-sm sm:rounded-lg">
                        <div className="p-4 space-y-2 bg-white rounded-lg shadow-lg">
                            ...
                            <Link href="/admin/case_study/create">
                                                    ...
                                                    (case_study) => (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="px-3 py-2 text-center md:px-4 md:py-3">
                                                                <Link
                                                                    href={`/admin/case_study/${case_study.id}/edit`}
                                                                >
                                                                    <Button>
                                                                        Edit
                                                                    </Button>
