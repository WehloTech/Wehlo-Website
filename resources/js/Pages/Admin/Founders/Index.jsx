...
const Founders = () => {
    ...
    const fetchData = async () => {
        try {
            // ✅ make sure you have this route name in web.php
            // example: Route::get('/admin/founders/data', ...)->name('founders.data');
            const response = await axios.get(route("founders.data"));
    ...
    // ✅ adjust fields based on your founders table columns
    // (example: name)
    const filteredItems = founders.filter((item) =>
        (item.name || "")
            .toLowerCase()
    ...
    const deleteItem = (id) => {
        // ✅ make sure you have founders.destroy route name
        useDeleteModal(id, "founders.destroy", () => {
                ...
                <div className="w-full mx-auto md:max-w-2xl lg:max-w-7xl">
                    <div className="overflow-auto bg-white shadow-sm sm:rounded-lg">
                        <div className="p-4 space-y-2 bg-white rounded-lg shadow-lg">
                            ...
                            <Link href="/admin/founders/create">
                                <Button>Create Founder</Button>
                            </Link>
                                                            ...
                                                            <td className="px-3 py-2 md:px-4 md:py-3">
                                                                {founder.image ? (
                                                                    <img
                                                                        ...
                                                                        alt="Founder"
                                                                        className="object-cover w-20 h-20 rounded mx-auto"
                                                                    />
                                                                ) : (
